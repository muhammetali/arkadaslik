...
class _ProfileDetailsPageState extends State<ProfileDetailsPage> {
  ...
  final String? _bannerAdUnitIdTemp = !isIOSPlatform()
      ? configItem('ads.profile_banner_ad.android_ad_unit_id')
      : configItem('ads.profile_banner_ad.ios_ad_unit_id');
  ...
  void initState() {
    if (mounted) {
      _bannerAdUnitId = _bannerAdUnitIdTemp == null ? '' : _bannerAdUnitId;
    ...
    data_transport.get(
      ...
      onSuccess: (responseData) {
        setState(() {
          ...
          userProfileDetails = data?['data']['userProfileData'];
          userSpecificationData = data?['data']['specifications'];
